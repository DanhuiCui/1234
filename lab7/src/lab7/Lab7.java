...
public class Lab7 {
    ...
    private void runAnalysis(){
        ...
        int max= helper.getPostWithMostLikedComment();
        System.out.println("PostID with most liked comments: " + max);
        
        System.out.print("\r\n");
        helper.getPostWithMostComments();
        
        System.out.print("\r\n");
        helper.getTop5UsersWithPosts();
        
        System.out.print("\r\n");
        helper.getTop5UsersWithComments();
        
        System.out.print("\r\n");
        helper.getTop5InactiveUsers();
        
        System.out.print("\r\n");
        helper.getTop5ProactiveUsers();
